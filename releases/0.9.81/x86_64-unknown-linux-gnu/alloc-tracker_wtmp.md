...
| :-- | ---: | :--- | ---: | ---: | ---: |
| `src/s4/s4.rs:3403:16`<br/>`s4::s4::cli_process_args::h88e0e2c6d5cbf9e2` | 1 | `main` | 208 | 25,429 (24.83 KiB) | 122 (122 B) |
| `src/s4/s4.rs:5330:53`<br/>`s4::s4::processing_loop::recv_many_chan::hcf11e7434d98ce19` | 1 | `main` | 56 | 7,168 (7.00 KiB) | 128 (128 B) |
| `src/data/fixedstruct.rs:4243:17`<br/>`s4lib::data::fixedstruct::buffer_to_fixedstructptr::he46da84748bc30a3` | 3 | `wtmp` | 55 | 21,120 (20.62 KiB) | 384 (384 B) |
...
| `src/readers/fixedstructreader.rs:1074:17`<br/>`s4lib::readers::fixedstructreader::FixedStructReader::score_file::h2ae5f249457eda7d` | 3 | `wtmp` | 20 | 800 (800 B) | 40 (40 B) |
| `src/readers/fixedstructreader.rs:1294:13`<br/>`s4lib::readers::fixedstructreader::FixedStructReader::preprocess_timevalues::h7fa77ef536fdc632` | 3 | `wtmp` | 9 | 2,616 (2.55 KiB) | 290 (290 B) |
| `src/s4/s4.rs:3748:5`<br/>`s4::s4::set_signal_handler::h125013a81a433b00` | 1 | `main` | 7 | 181 (181 B) | 25 (25 B) |
| `src/data/fixedstruct.rs:4229:17`<br/>`s4lib::data::fixedstruct::buffer_to_fixedstructptr::he46da84748bc30a3` | 3 | `wtmp` | 5 | 320 (320 B) | 64 (64 B) |
| `src/data/fixedstruct.rs:4222:17`<br/>`s4lib::data::fixedstruct::buffer_to_fixedstructptr::he46da84748bc30a3` | 3 | `wtmp` | 5 | 320 (320 B) | 64 (64 B) |
| `src/s4/s4.rs:5242:15`<br/>`s4::s4::processing_loop::h35d3236bfe375cc8` | 1 | `main` | 5 | 269 (269 B) | 53 (53 B) |
| `src/data/fixedstruct.rs:4271:17`<br/>`s4lib::data::fixedstruct::buffer_to_fixedstructptr::he46da84748bc30a3` | 3 | `wtmp` | 5 | 160 (160 B) | 32 (32 B) |
| `src/s4/s4.rs:353:13`<br/>`s4::s4::LOCAL_NOW::__init::{{closure}}::h9e9a6660e9e40986` | 1 | `main` | 3 | 5,924 (5.79 KiB) | 1,974 (1.93 KiB) |
| `src/readers/blockreader.rs:1836:35`<br/>`s4lib::readers::blockreader::BlockReader::new::h981894b8168c10ac` | 3 | `wtmp` | 3 | 216 (216 B) | 72 (72 B) |
...
| `src/s4/s4.rs:3914:11`<br/>`s4::s4::chan_send::hbf90949ec8f45664` | 3 | `wtmp` | 2 | 144 (144 B) | 72 (72 B) |
| `src/s4/s4.rs:5359:59`<br/>`s4::s4::processing_loop::recv_many_chan::hcf11e7434d98ce19` | 1 | `main` | 2 | 144 (144 B) | 72 (72 B) |
| `src/s4/s4.rs:5172:13`<br/>`s4::s4::processing_loop::h35d3236bfe375cc8` | 1 | `main` | 2 | 52 (52 B) | 26 (26 B) |
| `src/data/fixedstruct.rs:4711:19`<br/>`s4lib::data::fixedstruct::FixedStruct::as_bytes::hb732a545ba8e4e72` | 1 | `main` | 2 | 24 (24 B) | 12 (12 B) |
| `src/readers/blockreader.rs:2775:26`<br/>`s4lib::readers::blockreader::BlockReader::read_block_File::h2724c37489099d5b` | 3 | `wtmp` | 1 | 25,728 (25.12 KiB) | 25,728 (25.12 KiB) |
...
| `src/readers/fixedstructreader.rs:823:9`<br/>`s4lib::readers::fixedstructreader::FixedStructReader::insert_cache_entry::h63aa5ae3e7e7d123` | 3 | `wtmp` | 1 | 808 (808 B) | 808 (808 B) |
...
| `src/readers/fixedstructreader.rs:500:25`<br/>`s4lib::readers::fixedstructreader::FixedStructReader::new::hcd4c8ab4e68063e2` | 3 | `wtmp` | 1 | 192 (192 B) | 192 (192 B) |
| `src/readers/blockreader.rs:2708:28`<br/>`s4lib::readers::blockreader::BlockReader::store_block_in_storage::hc30d4f1ef8950ec7` | 3 | `wtmp` | 1 | 192 (192 B) | 192 (192 B) |
...
| `src/readers/blockreader.rs:2722:14`<br/>`s4lib::readers::blockreader::BlockReader::store_block_in_storage::hc30d4f1ef8950ec7` | 3 | `wtmp` | 1 | 104 (104 B) | 104 (104 B) |
...
| `src/data/fixedstruct.rs:3827:9`<br/>`s4lib::data::fixedstruct::filesz_to_types::h1fbb1b9f26f8d5df` | 3 | `wtmp` | 1 | 88 (88 B) | 88 (88 B) |
...
| `src/readers/filepreprocessor.rs:1137:22`<br/>`s4lib::readers::filepreprocessor::process_path::hbbaea7b4727b31bc` | 1 | `main` | 1 | 79 (79 B) | 79 (79 B) |
...
| `src/data/fixedstruct.rs:3806:9`<br/>`s4lib::data::fixedstruct::filesz_to_types::h1fbb1b9f26f8d5df` | 3 | `wtmp` | 1 | 52 (52 B) | 52 (52 B) |
...
| `src/readers/blockreader.rs:2796:30`<br/>`s4lib::readers::blockreader::BlockReader::read_block_File::h2724c37489099d5b` | 3 | `wtmp` | 1 | 40 (40 B) | 40 (40 B) |
| `src/s4/s4.rs:2897:5`<br/>`s4::s4::cli_process_tz_offset::h89478d5e94c24d33` | 1 | `main` | 1 | 40 (40 B) | 40 (40 B) |
| `src/readers/blockreader.rs:2689:9`<br/>`s4lib::readers::blockreader::BlockReader::store_block_in_LRU_cache::h5305638563a478ee` | 3 | `wtmp` | 1 | 32 (32 B) | 32 (32 B) |
| `src/s4/s4.rs:4197:9`<br/>`s4::s4::exec_fixedstructprocessor::h71cac0d8f2b4ca6b` | 3 | `wtmp` | 1 | 26 (26 B) | 26 (26 B) |
| `src/readers/blockreader.rs:619:35`<br/>`s4lib::readers::blockreader::BlockReader::new::h981894b8168c10ac` | 3 | `wtmp` | 1 | 26 (26 B) | 26 (26 B) |
| `src/readers/fixedstructreader.rs:1530:20`<br/>`s4lib::readers::fixedstructreader::FixedStructReader::summary_complete::h73bf20ca18956b92` | 3 | `wtmp` | 1 | 26 (26 B) | 26 (26 B) |
| `src/readers/fixedstructreader.rs:348:54`<br/>`s4lib::readers::fixedstructreader::FixedStructReader::new::hcd4c8ab4e68063e2` | 3 | `wtmp` | 1 | 26 (26 B) | 26 (26 B) |
| `src/readers/blockreader.rs:651:20`<br/>`s4lib::readers::blockreader::BlockReader::new::h981894b8168c10ac` | 3 | `wtmp` | 1 | 26 (26 B) | 26 (26 B) |
| `src/readers/filepreprocessor.rs:1167:87`<br/>`s4lib::readers::filepreprocessor::process_path::hbbaea7b4727b31bc` | 1 | `main` | 1 | 26 (26 B) | 26 (26 B) |
| `src/readers/filepreprocessor.rs:1133:33`<br/>`s4lib::readers::filepreprocessor::process_path::hbbaea7b4727b31bc` | 1 | `main` | 1 | 26 (26 B) | 26 (26 B) |
| `src/s4/s4.rs:3448:29`<br/>`s4::s4::cli_process_args::h88e0e2c6d5cbf9e2` | 1 | `main` | 1 | 26 (26 B) | 26 (26 B) |
| `src/s4/s4.rs:5044:56`<br/>`s4::s4::processing_loop::h35d3236bfe375cc8` | 1 | `main` | 1 | 26 (26 B) | 26 (26 B) |
...
| :--- | ---: | ---: | :--- |
| normal allocations | 155,276 | 527 | normal program allocations; this is the most useful number |
| total deallocations | 177,630,817 | 210,598 | includes normal program deallocations and tracking deallocations |
| current outstanding | 66,865,352 | | outstanding allocated bytes as of this print |

## Allocator Tracking internals

| tracked | bytes | calls | about |
| :--- | ---: | ---: | :--- |
| total from tracking | 244,340,870 | 307,622 | tracking allocations; not part of the normal program allocations |
| tracking from backtrace | 242,626,567 | | tracking allocations specifically for `backtrace::trace` and `backtrace::resolve_frame`; subset of "total from tracking" |
| tracking from other | 1,714,303 | | other tracking allocations, not "from backtrace"; subset of "total from tracking" |
...
2026-05-28 22:55:57.804621038 -07:00
