+ exec env S4_ALLOC_TRACKER_DEPTH=1 S4_ALLOC_TRACKER_PRINT= S4_ALLOC_TRACKER_TRACKING=1 S4_BUILD_REGEX_PRINT=0 RUST_MIN_STACK=20000000 cargo run --quiet --profile alloc_tracker --features alloc_tracker -- ./logs/NetBSD9.3/Xorg.0.log
...
| :-- | ---: | :--- | ---: | ---: | ---: |
| `subprojects/ere/ere_datetimes_impl/src/ere_datetimes_impl.rs:2060:27`<br/>`super_speedy_syslog_searcher_ere_datetimes_impl::DATETIME_PARSE_DATAS::ere_match_fn_123::ere_match_struct_123::ENGINE_BYTES::exec::transition_epsilons_exec::h537ddf892aab2ffe` | 3 | `Xorg.0.log` | 40,053 | 2,378,508 (2.27 MiB) | 59 (59 B) |
| `src/readers/syslinereader.rs:1469:13`<br/>`s4lib::readers::syslinereader::SyslineReader::find_datetime_in_line::h76c64a27acc37abd` | 3 | `Xorg.0.log` | 1,030 | 24,720 (24.14 KiB) | 24 (24 B) |
| `src/readers/syslinereader.rs:1471:17`<br/>`s4lib::readers::syslinereader::SyslineReader::find_datetime_in_line::h76c64a27acc37abd` | 3 | `Xorg.0.log` | 515 | 32,960 (32.19 KiB) | 64 (64 B) |
...
| `src/data/line.rs:423:9`<br/>`s4lib::data::line::LinePart::block_boxptr_ab::hec527f9f26121cff` | 3 | `Xorg.0.log` | 515 | 8,240 (8.05 KiB) | 16 (16 B) |
| `src/readers/syslinereader.rs:1747:13`<br/>`s4lib::readers::syslinereader::SyslineReader::parse_datetime_in_line::hf868aae741c5f3b7` | 3 | `Xorg.0.log` | 515 | 4,120 (4.02 KiB) | 8 (8 B) |
| `subprojects/ere/ere_datetimes_impl/src/ere_datetimes_impl.rs:2060:27`<br/>`super_speedy_syslog_searcher_ere_datetimes_impl::DATETIME_PARSE_DATAS::ere_match_fn_123::ere_match_struct_123::ENGINE_BYTES::exec::haf48fb9fed91f767` | 3 | `Xorg.0.log` | 506 | 113,344 (110.69 KiB) | 224 (224 B) |
...
| `src/readers/linereader.rs:1313:29`<br/>`s4lib::readers::linereader::LineReader::find_line_in_block::hc904805666cce2d4` | 3 | `Xorg.0.log` | 7 | 336 (336 B) | 48 (48 B) |
...
| `src/readers/syslinereader.rs:553:13`<br/>`s4lib::readers::syslinereader::SyslineReader::new::ha5ee0ef8a85160d8` | 3 | `Xorg.0.log` | 1 | 192 (192 B) | 192 (192 B) |
...
| `src/readers/syslogprocessor.rs:1466:20`<br/>`s4lib::readers::syslogprocessor::SyslogProcessor::summary_complete::hfcc5018cbbf8a99a` | 3 | `Xorg.0.log` | 1 | 27 (27 B) | 27 (27 B) |
...
| `src/readers/syslinereader.rs:550:39`<br/>`s4lib::readers::syslinereader::SyslineReader::new::ha5ee0ef8a85160d8` | 3 | `Xorg.0.log` | 1 | 8 (8 B) | 8 (8 B) |
...
| :--- | ---: | ---: | :--- |
| normal allocations | 2,774,505 | 44,714 | normal program allocations; this is the most useful number |
| total deallocations | 125,915,167 | 314,539 | includes normal program deallocations and tracking deallocations |
| current outstanding | 45,125,416 | | outstanding allocated bytes as of this print |

## Allocator Tracking internals

| tracked | bytes | calls | about |
| :--- | ---: | ---: | :--- |
| total from tracking | 168,266,055 | 352,853 | tracking allocations; not part of the normal program allocations |
| tracking from backtrace | 166,551,918 | | tracking allocations specifically for `backtrace::trace` and `backtrace::resolve_frame`; subset of "total from tracking" |
| tracking from other | 1,714,137 | | other tracking allocations, not "from backtrace"; subset of "total from tracking" |
| ratio tracking to normal| 100 to 2 | 100 to 13 | ratio of tracking allocations/calls to normal program allocations/calls |
...
| call sites | 103 | entries in the table above |
| cached file names | 9 | |
| cached function names | 40 | |
