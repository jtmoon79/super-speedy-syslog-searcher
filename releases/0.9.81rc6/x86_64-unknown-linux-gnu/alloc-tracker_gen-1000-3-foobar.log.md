+ exec env S4_ALLOC_TRACKER_DEPTH=1 S4_ALLOC_TRACKER_PRINT= S4_ALLOC_TRACKER_TRACKING=1 S4_BUILD_REGEX_PRINT=0 RUST_MIN_STACK=20000000 cargo run --quiet --profile alloc_tracker --features alloc_tracker -- ./logs/other/tests/gen-1000-3-foobar.log
...
| `src/readers/blockreader.rs:2775:26`<br/>`s4lib::readers::blockreader::BlockReader::read_block_File::h7b2ca2ec4ce957ae` | 3 | `gen-1000-3-foobar.log` | 1 | 65,536 (64.00 KiB) | 65,536 (64.00 KiB) |
...
| `src/readers/blockreader.rs:2708:28`<br/>`s4lib::readers::blockreader::BlockReader::store_block_in_storage::hdaa8db484d68fd3e` | 3 | `gen-1000-3-foobar.log` | 1 | 192 (192 B) | 192 (192 B) |
...
| `src/readers/syslinereader.rs:1316:17`<br/>`s4lib::readers::syslinereader::SyslineReader::find_datetime_in_line::h76c64a27acc37abd` | 3 | `gen-1000-3-foobar.log` | 1 | 112 (112 B) | 112 (112 B) |
| `src/readers/blockreader.rs:2722:14`<br/>`s4lib::readers::blockreader::BlockReader::store_block_in_storage::hdaa8db484d68fd3e` | 3 | `gen-1000-3-foobar.log` | 1 | 104 (104 B) | 104 (104 B) |
...
| `src/s4/s4.rs:3962:9`<br/>`s4::s4::exec_syslogprocessor::h8106c39799c9915a` | 3 | `gen-1000-3-foobar.log` | 1 | 40 (40 B) | 40 (40 B) |
| `src/readers/blockreader.rs:619:35`<br/>`s4lib::readers::blockreader::BlockReader::new::h4ce67b93fa8e3683` | 3 | `gen-1000-3-foobar.log` | 1 | 40 (40 B) | 40 (40 B) |
...
| `src/readers/blockreader.rs:651:20`<br/>`s4lib::readers::blockreader::BlockReader::new::h4ce67b93fa8e3683` | 3 | `gen-1000-3-foobar.log` | 1 | 40 (40 B) | 40 (40 B) |
| `src/readers/blockreader.rs:2796:30`<br/>`s4lib::readers::blockreader::BlockReader::read_block_File::h7b2ca2ec4ce957ae` | 3 | `gen-1000-3-foobar.log` | 1 | 40 (40 B) | 40 (40 B) |
| `src/readers/syslogprocessor.rs:1466:20`<br/>`s4lib::readers::syslogprocessor::SyslogProcessor::summary_complete::hfcc5018cbbf8a99a` | 3 | `gen-1000-3-foobar.log` | 1 | 40 (40 B) | 40 (40 B) |
...
| :--- | ---: | ---: | :--- |
| normal allocations | 4,130,497 | 71,193 | normal program allocations; this is the most useful number |
| total deallocations | 129,066,581 | 396,313 | includes normal program deallocations and tracking deallocations |
| current outstanding | 45,132,178 | | outstanding allocated bytes as of this print |

## Allocator Tracking internals

| tracked | bytes | calls | about |
| :--- | ---: | ---: | :--- |
| total from tracking | 170,068,239 | 408,155 | tracking allocations; not part of the normal program allocations |
| tracking from backtrace | 168,353,945 | | tracking allocations specifically for `backtrace::trace` and `backtrace::resolve_frame`; subset of "total from tracking" |
| tracking from other | 1,714,294 | | other tracking allocations, not "from backtrace"; subset of "total from tracking" |
...
| call sites | 106 | entries in the table above |
| cached file names | 9 | |
