+ exec env S4_ALLOC_TRACKER_DEPTH=1 S4_ALLOC_TRACKER_PRINT= S4_ALLOC_TRACKER_TRACKING=1 S4_BUILD_REGEX_PRINT=0 RUST_MIN_STACK=20000000 cargo run --quiet --profile alloc_tracker --features alloc_tracker -- ./logs/RedHatEnterprise9/audit/audit.log
...
| :-- | ---: | :--- | ---: | ---: | ---: |
| `subprojects/ere/ere_datetimes_impl/src/ere_datetimes_impl.rs:2060:27`<br/>`super_speedy_syslog_searcher_ere_datetimes_impl::DATETIME_PARSE_DATAS::ere_match_fn_123::ere_match_struct_123::ENGINE_BYTES::exec::transition_epsilons_exec::h537ddf892aab2ffe` | 3 | `audit.log` | 4,975 | 277,790 (271.28 KiB) | 55 (55 B) |
...
| `src/readers/syslinereader.rs:1471:17`<br/>`s4lib::readers::syslinereader::SyslineReader::find_datetime_in_line::h76c64a27acc37abd` | 3 | `audit.log` | 38 | 3,648 (3.56 KiB) | 96 (96 B) |
| `src/readers/syslinereader.rs:1469:13`<br/>`s4lib::readers::syslinereader::SyslineReader::find_datetime_in_line::h76c64a27acc37abd` | 3 | `audit.log` | 38 | 912 (912 B) | 24 (24 B) |
| `subprojects/ere/ere_datetimes_impl/src/ere_datetimes_impl.rs:2060:27`<br/>`super_speedy_syslog_searcher_ere_datetimes_impl::DATETIME_PARSE_DATAS::ere_match_fn_123::ere_match_struct_123::ENGINE_BYTES::exec::haf48fb9fed91f767` | 3 | `audit.log` | 19 | 4,256 (4.16 KiB) | 224 (224 B) |
...
| `src/data/line.rs:423:9`<br/>`s4lib::data::line::LinePart::block_boxptr_ab::hec527f9f26121cff` | 3 | `audit.log` | 19 | 304 (304 B) | 16 (16 B) |
| `src/readers/syslinereader.rs:1747:13`<br/>`s4lib::readers::syslinereader::SyslineReader::parse_datetime_in_line::hf868aae741c5f3b7` | 3 | `audit.log` | 19 | 152 (152 B) | 8 (8 B) |
| `src/readers/linereader.rs:1313:29`<br/>`s4lib::readers::linereader::LineReader::find_line_in_block::hc904805666cce2d4` | 3 | `audit.log` | 7 | 336 (336 B) | 48 (48 B) |
...
| `src/readers/syslinereader.rs:553:13`<br/>`s4lib::readers::syslinereader::SyslineReader::new::ha5ee0ef8a85160d8` | 3 | `audit.log` | 1 | 192 (192 B) | 192 (192 B) |
...
| `src/readers/syslogprocessor.rs:1466:20`<br/>`s4lib::readers::syslogprocessor::SyslogProcessor::summary_complete::hfcc5018cbbf8a99a` | 3 | `audit.log` | 1 | 40 (40 B) | 40 (40 B) |
...
| `src/readers/syslinereader.rs:550:39`<br/>`s4lib::readers::syslinereader::SyslineReader::new::ha5ee0ef8a85160d8` | 3 | `audit.log` | 1 | 8 (8 B) | 8 (8 B) |
...
| :--- | ---: | ---: | :--- |
| normal allocations | 389,363 | 5,536 | normal program allocations; this is the most useful number |
| total deallocations | 120,858,984 | 193,832 | includes normal program deallocations and tracking deallocations |
| current outstanding | 45,130,552 | | outstanding allocated bytes as of this print |

## Allocator Tracking internals

| tracked | bytes | calls | about |
| :--- | ---: | ---: | :--- |
| total from tracking | 165,600,150 | 271,324 | tracking allocations; not part of the normal program allocations |
| tracking from backtrace | 163,886,062 | | tracking allocations specifically for `backtrace::trace` and `backtrace::resolve_frame`; subset of "total from tracking" |
| tracking from other | 1,714,088 | | other tracking allocations, not "from backtrace"; subset of "total from tracking" |
| ratio tracking to normal| 100 to 0 | 100 to 2 | ratio of tracking allocations/calls to normal program allocations/calls |
