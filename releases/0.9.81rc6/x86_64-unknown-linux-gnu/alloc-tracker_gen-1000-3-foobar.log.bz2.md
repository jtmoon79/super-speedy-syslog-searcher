+ exec env S4_ALLOC_TRACKER_DEPTH=1 S4_ALLOC_TRACKER_PRINT= S4_ALLOC_TRACKER_TRACKING=1 S4_BUILD_REGEX_PRINT=0 RUST_MIN_STACK=20000000 cargo run --quiet --profile alloc_tracker --features alloc_tracker -- ./logs/other/tests/gen-1000-3-foobar.log.bz2
...
| :-- | ---: | :--- | ---: | ---: | ---: |
| `subprojects/ere/ere_datetimes_impl/src/ere_datetimes_impl.rs:2060:27`<br/>`super_speedy_syslog_searcher_ere_datetimes_impl::DATETIME_PARSE_DATAS::ere_match_fn_123::ere_match_struct_123::ENGINE_BYTES::exec::transition_epsilons_exec::h537ddf892aab2ffe` | 3 | `gen-1000-3-foobar.log.bz2` | 66,365 | 3,664,630 (3.49 MiB) | 55 (55 B) |
| `src/readers/syslinereader.rs:1471:17`<br/>`s4lib::readers::syslinereader::SyslineReader::find_datetime_in_line::h76c64a27acc37abd` | 3 | `gen-1000-3-foobar.log.bz2` | 952 | 91,392 (89.25 KiB) | 96 (96 B) |
| `src/readers/syslinereader.rs:1469:13`<br/>`s4lib::readers::syslinereader::SyslineReader::find_datetime_in_line::h76c64a27acc37abd` | 3 | `gen-1000-3-foobar.log.bz2` | 952 | 22,848 (22.31 KiB) | 24 (24 B) |
| `src/data/line.rs:513:24`<br/>`<s4lib::data::line::Line as core::default::Default>::default::h718aa466535c25c4` | 3 | `gen-1000-3-foobar.log.bz2` | 477 | 22,896 (22.36 KiB) | 48 (48 B) |
| `src/readers/syslinereader.rs:1747:13`<br/>`s4lib::readers::syslinereader::SyslineReader::parse_datetime_in_line::hf868aae741c5f3b7` | 3 | `gen-1000-3-foobar.log.bz2` | 477 | 3,816 (3.73 KiB) | 8 (8 B) |
| `subprojects/ere/ere_datetimes_impl/src/ere_datetimes_impl.rs:2060:27`<br/>`super_speedy_syslog_searcher_ere_datetimes_impl::DATETIME_PARSE_DATAS::ere_match_fn_123::ere_match_struct_123::ENGINE_BYTES::exec::haf48fb9fed91f767` | 3 | `gen-1000-3-foobar.log.bz2` | 476 | 106,624 (104.12 KiB) | 224 (224 B) |
| `src/readers/linereader.rs:473:28`<br/>`s4lib::readers::linereader::LineReader::insert_line::he3485a08fab6fb11` | 3 | `gen-1000-3-foobar.log.bz2` | 476 | 19,040 (18.59 KiB) | 40 (40 B) |
| `src/data/line.rs:423:9`<br/>`s4lib::data::line::LinePart::block_boxptr_ab::hec527f9f26121cff` | 3 | `gen-1000-3-foobar.log.bz2` | 476 | 7,616 (7.44 KiB) | 16 (16 B) |
| `src/s4/s4.rs:3403:16`<br/>`s4::s4::cli_process_args::hc2513eaa31d17c92` | 1 | `main` | 208 | 25,481 (24.88 KiB) | 122 (122 B) |
| `src/readers/linereader.rs:495:9`<br/>`s4lib::readers::linereader::LineReader::insert_line::he3485a08fab6fb11` | 3 | `gen-1000-3-foobar.log.bz2` | 78 | 15,936 (15.56 KiB) | 204 (204 B) |
| `src/readers/linereader.rs:482:9`<br/>`s4lib::readers::linereader::LineReader::insert_line::he3485a08fab6fb11` | 3 | `gen-1000-3-foobar.log.bz2` | 78 | 15,936 (15.56 KiB) | 204 (204 B) |
...
| `src/readers/blockreader.rs:799:27`<br/>`s4lib::readers::blockreader::BlockReader::new::h4ce67b93fa8e3683` | 3 | `gen-1000-3-foobar.log.bz2` | 9 | 3,632,492 (3.46 MiB) | 403,610 (394.15 KiB) |
| `src/readers/blockreader.rs:2900:23`<br/>`s4lib::readers::blockreader::BlockReader::read_block_FileBz2::hb655474544cb84da` | 3 | `gen-1000-3-foobar.log.bz2` | 7 | 3,632,201 (3.46 MiB) | 518,885 (506.72 KiB) |
| `src/readers/linereader.rs:1313:29`<br/>`s4lib::readers::linereader::LineReader::find_line_in_block::hc904805666cce2d4` | 3 | `gen-1000-3-foobar.log.bz2` | 7 | 336 (336 B) | 48 (48 B) |
...
| `src/readers/syslinereader.rs:591:47`<br/>`s4lib::readers::syslinereader::SyslineReader::new::ha5ee0ef8a85160d8` | 3 | `gen-1000-3-foobar.log.bz2` | 3 | 416 (416 B) | 138 (138 B) |
| `src/readers/linereader.rs:273:34`<br/>`s4lib::readers::linereader::LineReader::new::h35461f372328eb57` | 3 | `gen-1000-3-foobar.log.bz2` | 3 | 384 (384 B) | 128 (128 B) |
| `src/readers/syslinereader.rs:584:37`<br/>`s4lib::readers::syslinereader::SyslineReader::new::ha5ee0ef8a85160d8` | 3 | `gen-1000-3-foobar.log.bz2` | 3 | 248 (248 B) | 82 (82 B) |
| `src/readers/blockreader.rs:1836:35`<br/>`s4lib::readers::blockreader::BlockReader::new::h4ce67b93fa8e3683` | 3 | `gen-1000-3-foobar.log.bz2` | 3 | 216 (216 B) | 72 (72 B) |
...
| `src/readers/filepreprocessor.rs:368:18`<br/>`s4lib::readers::filepreprocessor::pathbuf_to_filetype_impl::h7ee028a2b403903e` | 1 | `main` | 2 | 179 (179 B) | 89 (89 B) |
...
| `src/readers/syslinereader.rs:1314:44`<br/>`s4lib::readers::syslinereader::SyslineReader::find_datetime_in_line::h76c64a27acc37abd` | 3 | `gen-1000-3-foobar.log.bz2` | 2 | 48 (48 B) | 24 (24 B) |
...
| `src/readers/blockreader.rs:2891:29`<br/>`s4lib::readers::blockreader::BlockReader::read_block_FileBz2::hb655474544cb84da` | 3 | `gen-1000-3-foobar.log.bz2` | 1 | 65,536 (64.00 KiB) | 65,536 (64.00 KiB) |
...
| `src/readers/syslogprocessor.rs:174:9`<br/>`<s4lib::readers::syslogprocessor::BLOCKZERO_ANALYSIS_LINE_COUNT_MIN_MAP as core::ops::deref::Deref>::deref::__static_ref_initialize::hd3d24ad1fe727c40` | 3 | `gen-1000-3-foobar.log.bz2` | 1 | 280 (280 B) | 280 (280 B) |
| `src/readers/syslogprocessor.rs:189:9`<br/>`<s4lib::readers::syslogprocessor::BLOCKZERO_ANALYSIS_SYSLINE_COUNT_MIN_MAP as core::ops::deref::Deref>::deref::__static_ref_initialize::h0672a2de9a87b4ff` | 3 | `gen-1000-3-foobar.log.bz2` | 1 | 280 (280 B) | 280 (280 B) |
...
| `src/readers/blockreader.rs:2708:28`<br/>`s4lib::readers::blockreader::BlockReader::store_block_in_storage::hdaa8db484d68fd3e` | 3 | `gen-1000-3-foobar.log.bz2` | 1 | 192 (192 B) | 192 (192 B) |
| `src/readers/syslinereader.rs:553:13`<br/>`s4lib::readers::syslinereader::SyslineReader::new::ha5ee0ef8a85160d8` | 3 | `gen-1000-3-foobar.log.bz2` | 1 | 192 (192 B) | 192 (192 B) |
...
| `src/readers/syslinereader.rs:1316:17`<br/>`s4lib::readers::syslinereader::SyslineReader::find_datetime_in_line::h76c64a27acc37abd` | 3 | `gen-1000-3-foobar.log.bz2` | 1 | 112 (112 B) | 112 (112 B) |
| `src/readers/blockreader.rs:2722:14`<br/>`s4lib::readers::blockreader::BlockReader::store_block_in_storage::hdaa8db484d68fd3e` | 3 | `gen-1000-3-foobar.log.bz2` | 1 | 104 (104 B) | 104 (104 B) |
...
| `src/readers/linereader.rs:1129:21`<br/>`s4lib::readers::linereader::LineReader::find_line_in_block::hc904805666cce2d4` | 3 | `gen-1000-3-foobar.log.bz2` | 1 | 48 (48 B) | 48 (48 B) |
| `src/s4/s4.rs:3421:33`<br/>`s4::s4::cli_process_args::hc2513eaa31d17c92` | 1 | `main` | 1 | 48 (48 B) | 48 (48 B) |
| `src/readers/syslogprocessor.rs:1466:20`<br/>`s4lib::readers::syslogprocessor::SyslogProcessor::summary_complete::hfcc5018cbbf8a99a` | 3 | `gen-1000-3-foobar.log.bz2` | 1 | 44 (44 B) | 44 (44 B) |
| `src/readers/blockreader.rs:619:35`<br/>`s4lib::readers::blockreader::BlockReader::new::h4ce67b93fa8e3683` | 3 | `gen-1000-3-foobar.log.bz2` | 1 | 44 (44 B) | 44 (44 B) |
| `src/readers/blockreader.rs:651:20`<br/>`s4lib::readers::blockreader::BlockReader::new::h4ce67b93fa8e3683` | 3 | `gen-1000-3-foobar.log.bz2` | 1 | 44 (44 B) | 44 (44 B) |
| `src/s4/s4.rs:3962:9`<br/>`s4::s4::exec_syslogprocessor::h8106c39799c9915a` | 3 | `gen-1000-3-foobar.log.bz2` | 1 | 44 (44 B) | 44 (44 B) |
...
| `src/readers/blockreader.rs:2995:26`<br/>`s4lib::readers::blockreader::BlockReader::read_block_FileBz2::hb655474544cb84da` | 3 | `gen-1000-3-foobar.log.bz2` | 1 | 40 (40 B) | 40 (40 B) |
| `src/readers/syslinereader.rs:2098:74`<br/>`s4lib::readers::syslinereader::SyslineReader::find_sysline_in_block_year::haa1f8fb8b36f2fa7` | 3 | `gen-1000-3-foobar.log.bz2` | 1 | 40 (40 B) | 40 (40 B) |
| `src/s4/s4.rs:2897:5`<br/>`s4::s4::cli_process_tz_offset::ha0fcee891a25dea7` | 1 | `main` | 1 | 40 (40 B) | 40 (40 B) |
| `src/readers/blockreader.rs:2689:9`<br/>`s4lib::readers::blockreader::BlockReader::store_block_in_LRU_cache::h9597576df80bd0c6` | 3 | `gen-1000-3-foobar.log.bz2` | 1 | 32 (32 B) | 32 (32 B) |
...
| `src/readers/syslinereader.rs:550:39`<br/>`s4lib::readers::syslinereader::SyslineReader::new::ha5ee0ef8a85160d8` | 3 | `gen-1000-3-foobar.log.bz2` | 1 | 8 (8 B) | 8 (8 B) |
| `src/readers/syslinereader.rs:580:31`<br/>`s4lib::readers::syslinereader::SyslineReader::new::ha5ee0ef8a85160d8` | 3 | `gen-1000-3-foobar.log.bz2` | 1 | 8 (8 B) | 8 (8 B) |
...
| :--- | ---: | ---: | :--- |
| normal allocations | 11,395,444 | 71,212 | normal program allocations; this is the most useful number |
| total deallocations | 136,377,148 | 396,450 | includes normal program deallocations and tracking deallocations |
| current outstanding | 45,149,626 | | outstanding allocated bytes as of this print |

## Allocator Tracking internals

| tracked | bytes | calls | about |
| :--- | ---: | ---: | :--- |
| total from tracking | 170,131,307 | 408,297 | tracking allocations; not part of the normal program allocations |
| tracking from backtrace | 168,416,844 | | tracking allocations specifically for `backtrace::trace` and `backtrace::resolve_frame`; subset of "total from tracking" |
| tracking from other | 1,714,463 | | other tracking allocations, not "from backtrace"; subset of "total from tracking" |
| ratio tracking to normal| 100 to 7 | 100 to 17 | ratio of tracking allocations/calls to normal program allocations/calls |
