...
`$ s4  ./logs/programs/evtx/Microsoft-Windows-Kernel-PnP__Configuration.evtx`
...
| total deallocations | 211,861,691 | 212,991 | includes normal program deallocations and tracking deallocations |
| current outstanding | 67,839,559 | | outstanding allocated bytes as of this print |

## Allocator Tracking internals

| tracked | bytes | calls | about |
| :--- | ---: | ---: | :--- |
| total from tracking | 251,479,203 | 307,941 | tracking allocations; not part of the normal program allocations |
| tracking from backtrace | 245,598,296 | | tracking allocations specifically for `backtrace::trace` and `backtrace::resolve_frame`; subset of "total from tracking" |
| tracking from other | 5,880,907 | | other tracking allocations, not "from backtrace"; subset of "total from tracking" |
...
Generated on Wed May 27 12:24:54 PM PDT 2026 by `./tools/s4-alloc_trackers.sh`
