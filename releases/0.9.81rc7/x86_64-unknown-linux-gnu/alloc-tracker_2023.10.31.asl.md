...
`$ s4  ./logs/MacOS11/DiagnosticMessages/2023.10.31.asl`
...
| total deallocations | 179,895,894 | 213,570 | includes normal program deallocations and tracking deallocations |
| current outstanding | 67,643,507 | | outstanding allocated bytes as of this print |

## Allocator Tracking internals

| tracked | bytes | calls | about |
| :--- | ---: | ---: | :--- |
| total from tracking | 247,212,455 | 307,665 | tracking allocations; not part of the normal program allocations |
| tracking from backtrace | 245,328,311 | | tracking allocations specifically for `backtrace::trace` and `backtrace::resolve_frame`; subset of "total from tracking" |
| tracking from other | 1,884,144 | | other tracking allocations, not "from backtrace"; subset of "total from tracking" |
...
Generated on Wed May 27 12:16:42 PM PDT 2026 by `./tools/s4-alloc_trackers.sh`
