...
`$ s4  ./logs/programs/journal/RHE_91_system.journal`
...
| total deallocations | 184,600,674 | 279,423 | includes normal program deallocations and tracking deallocations |
| current outstanding | 67,632,055 | | outstanding allocated bytes as of this print |

## Allocator Tracking internals

| tracked | bytes | calls | about |
| :--- | ---: | ---: | :--- |
| total from tracking | 248,825,405 | 357,792 | tracking allocations; not part of the normal program allocations |
| tracking from backtrace | 247,111,811 | | tracking allocations specifically for `backtrace::trace` and `backtrace::resolve_frame`; subset of "total from tracking" |
| tracking from other | 1,713,594 | | other tracking allocations, not "from backtrace"; subset of "total from tracking" |
...
Generated on Wed May 27 12:24:57 PM PDT 2026 by `./tools/s4-alloc_trackers.sh`
