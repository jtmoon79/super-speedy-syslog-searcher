...
`$ s4  ./logs/OpenBSD7.4/x86_64/utmp`
...
| total deallocations | 179,342,166 | 207,654 | includes normal program deallocations and tracking deallocations |
| current outstanding | 67,636,062 | | outstanding allocated bytes as of this print |

## Allocator Tracking internals

| tracked | bytes | calls | about |
| :--- | ---: | ---: | :--- |
| total from tracking | 246,872,908 | 303,248 | tracking allocations; not part of the normal program allocations |
| tracking from backtrace | 245,159,136 | | tracking allocations specifically for `backtrace::trace` and `backtrace::resolve_frame`; subset of "total from tracking" |
| tracking from other | 1,713,772 | | other tracking allocations, not "from backtrace"; subset of "total from tracking" |
...
Generated on Wed May 27 12:16:48 PM PDT 2026 by `./tools/s4-alloc_trackers.sh`
