...
* Update the performance table comparison.
* Update any new supported features.
-->
...
A C compiler is required. [_Rust_ must be installed].
...
#### `mimalloc`, `jemalloc`, or `rpmalloc`<!-- omit in toc -->
...
#### Red Hat and CentOS<!-- omit in toc -->
...
#### allocator `tcmalloc`<!-- omit in toc -->
...
#### File name guessing<!-- omit in toc -->
...
#### Multiple platforms<!-- omit in toc -->
...
#### Formal Log DateTime Supported<!-- omit in toc -->
...
#### Other Log or File Formats Supported<!-- omit in toc -->
...
#### Archive Formats Supported<!-- omit in toc -->
...
#### Table of performance comparison results<!-- omit in toc -->
...
<sup style="font-size: xxx-small">• _Mean_ is mean runtime in milliseconds</sup>
<sup style="font-size: xxx-small">• _Max RSS_ is maximum Resident Set Size in Kilobytes</sup>
...
### "syslog" And Other Project Definitions<!-- omit in toc -->
