...
pub const DATETIME_PARSE_DATAS: [DateTimeParseInstr; DATETIME_PARSE_DATAS_LEN] = [
    ...
    ERE_REGEX_DATETIME!(
        7,
        counter!(DP_KEY),
        concat!("^<", RP_DIGITS3, ">", RP_BLANKq, CGP_YEAR, D_Dq, CGP_MONTHm, D_Dq, CGP_DAYde, D_DHcdq, CGP_HOUR, D_Te, CGP_MINUTE, D_Te, CGP_SECOND, D_SF, CGP_FRACTIONAL19, RP_BLANKq, CGP_TZzc, RP_NODIGIT),
        DfaU8,
        DTFSS_YmdHMSfzc,
        0, 50,
        CGN_YEAR, CGN_TZ,
    ...
    ERE_REGEX_DATETIME!(
        8,
        counter!(DP_KEY),
        concat!("^<", RP_DIGITS3, ">", RP_BLANKq, CGP_YEAR, D_Dq, CGP_MONTHm, D_Dq, CGP_DAYde, D_DHcdq, CGP_HOUR, D_Te, CGP_MINUTE, D_Te, CGP_SECOND, D_SF, CGP_FRACTIONAL19, RP_BLANKq, CGP_TZz, RP_NODIGIT),
        DfaU8,
        DTFSS_YmdHMSfz,
        0, 50,
        CGN_YEAR, CGN_TZ,
    ...
    ERE_REGEX_DATETIME!(
        9,
        counter!(DP_KEY),
        concat!("^<", RP_DIGITS3, ">", RP_BLANKq, CGP_YEAR, D_Dq, CGP_MONTHm, D_Dq, CGP_DAYde, D_DHcdq, CGP_HOUR, D_Te, CGP_MINUTE, D_Te, CGP_SECOND, D_SF, CGP_FRACTIONAL19, RP_BLANKq, CGP_TZzp, RP_NODIGIT),
        DfaU8,
        DTFSS_YmdHMSfzp,
        0, 50,
        CGN_YEAR, CGN_TZ,
    ...
    ERE_REGEX_DATETIME!(
        11,
        counter!(DP_KEY),
        concat!("^<", RP_DIGITS3, ">", RP_BLANKq, CGP_YEAR, D_Dq, CGP_MONTHm, D_Dq, CGP_DAYde, D_DHcdq, CGP_HOUR, D_Te, CGP_MINUTE, D_Te, CGP_SECOND, D_SF, CGP_FRACTIONAL19, RP_NOALNUM),
        DfaU8,
        DTFSS_YmdHMSf,
        0, 50,
        CGN_YEAR, CGN_FRACTIONAL,
    ...
    ERE_REGEX_DATETIME!(
        45,
        counter!(DP_KEY),
        concat!(CGP_YEAR, D_Dq, CGP_MONTHm, D_Dq, CGP_DAYde, D_DHcdq, CGP_HOUR, D_Te, CGP_MINUTE, D_Te, CGP_SECOND, ":", RP_BLANKe),
        FlatLockstepNfaU8,
        DTFSS_YmdHMS,
        0, 30,
        CGN_YEAR, CGN_SECOND,
    ...
    ERE_REGEX_DATETIME!(
        ...
        concat!(r"^\[", CGP_YEAR, D_D, CGP_MONTHm, D_D, CGP_DAYde, D_DHq, CGP_HOUR, D_Te, CGP_MINUTE, r"\]"),
        DfaU8,
        DTFSS_YmdHM,
        0, 20,
        CGN_YEAR, CGN_MINUTE,
    ...
    ERE_REGEX_DATETIME!(
        103,
        counter!(DP_KEY),
        concat!(r#""(TIMESTAMP|Timestamp|timestamp)""#, RP_BLANKq, ":", RP_BLANKq, "\"", CGP_YEAR, D_Dq, CGP_MONTHm, D_Dq, CGP_DAYde, D_DHcdq, CGP_HOUR, D_Te, CGP_MINUTE, D_Te, CGP_SECOND, D_SF, CGP_FRACTIONAL19, RP_BLANKq, CGP_TZZ, "\""),
        ...
        CGN_YEAR, CGN_TZ,
        &[
            (53, 77, (O_Z, 2000, 1, 2, 5, 1, 32, 123000000), br#"{"level":"INFO", b"message":"Started", b"timestamp":"2000-01-02T05:01:32.123Z"}"#),
            (16, 43, (O_M8, 2000, 1, 2, 5, 1, 32, 123000000), br#"{"TIMESTAMP" : "2000/01/02 05-01-32.123 PST", b"data" : ""}"#),
        ],
        line!(),
    ),
    ...
    ERE_REGEX_DATETIME!(
        104,
        counter!(DP_KEY),
        concat!(r#""(TIMESTAMP|Timestamp|timestamp)""#, RP_BLANKq, ":", RP_BLANKq, "\"", CGP_YEAR, D_Dq, CGP_MONTHm, D_Dq, CGP_DAYde, D_DHcdq, CGP_HOUR, D_Te, CGP_MINUTE, D_Te, CGP_SECOND, D_SF, CGP_FRACTIONAL19, RP_BLANKq, CGP_TZzc, "\""),
        DfaU8,
        DTFSS_YmdHMSfzc,
        0, 2056,
        CGN_YEAR, CGN_TZ,
        &[
            (53, 82, (O_Z, 2000, 1, 2, 5, 1, 32, 123000000), br#"{"level":"INFO", b"message":"Started", b"timestamp":"2000-01-02T05:01:32.123+00:00"}"#),
            (16, 46, (O_M8, 2000, 1, 2, 5, 1, 32, 123000000), br#"{"TIMESTAMP" : "2000/01/02 05-01-32.123 -08:00", b"data" : ""}"#),
    ...
    ERE_REGEX_DATETIME!(
        ...
        CGN_YEAR, CGN_TZ,
        &[
            (53, 81, (O_Z, 2000, 1, 2, 5, 1, 32, 123000000), br#"{"level":"INFO", b"message":"Started", b"timestamp":"2000-01-02T05:01:32.123+0000"}"#),
            (16, 45, (O_M8, 2000, 1, 2, 5, 1, 32, 123000000), br#"{"TIMESTAMP" : "2000/01/02 05-01-32.123 -0800", b"data" : ""}"#),
        ],
        line!(),
    ),
    ...
    ERE_REGEX_DATETIME!(
        106,
        counter!(DP_KEY),
        concat!(r#""(TIMESTAMP|Timestamp|timestamp)""#, RP_BLANKq, ":", RP_BLANKq, "\"", CGP_YEAR, D_Dq, CGP_MONTHm, D_Dq, CGP_DAYde, D_DHcdq, CGP_HOUR, D_Te, CGP_MINUTE, D_Te, CGP_SECOND, D_SF, CGP_FRACTIONAL19, RP_BLANKq, CGP_TZzp, "\""),
        DfaU8,
        DTFSS_YmdHMSfzp,
        0, 2056,
        CGN_YEAR, CGN_TZ,
        &[
            (53, 80, (O_Z, 2000, 1, 2, 5, 1, 32, 123000000), br#"{"level":"INFO", b"message":"Started", b"timestamp":"2000-01-02T05:01:32.123 +00"}"#),
            (16, 42, (O_M8, 2000, 1, 2, 5, 1, 32, 123000000), br#"{"TIMESTAMP" : "2000/01/02 05-01-32.123-08", b"data" : ""}"#),
        ],
        line!(),
    ),
    ...
    ERE_REGEX_DATETIME!(
        107,
        counter!(DP_KEY),
        concat!(r#""(TIMESTAMP|Timestamp|timestamp)""#, RP_BLANKq, ":", RP_BLANKq, "\"", CGP_YEAR, D_Dq, CGP_MONTHm, D_Dq, CGP_DAYde, D_DHcdq, CGP_HOUR, D_Te, CGP_MINUTE, D_Te, CGP_SECOND, D_SF, CGP_FRACTIONAL19, "\""),
        DfaU8,
        DTFSS_YmdHMSf,
        0, 2056,
        CGN_YEAR, CGN_FRACTIONAL,
        &[
            (53, 76, (O_L, 2000, 1, 2, 5, 1, 32, 123000000), br#"{"level":"INFO", b"message":"Started", b"timestamp":"2000-01-02T05:01:32.123"}"#),
            (16, 39, (O_L, 2000, 1, 2, 5, 1, 32, 123000000), br#"{"TIMESTAMP" : "2000/01/02 05-01-32.123", b"data" : ""}"#),
        ],
        line!(),
    ),
    ...
    ERE_REGEX_DATETIME!(
        ...
        concat!(r#""(TIMESTAMP|Timestamp|timestamp)""#, RP_BLANKq, ":", RP_BLANKq, "\"", CGP_YEAR, D_Dq, CGP_MONTHm, D_Dq, CGP_DAYde, D_DHcdq, CGP_HOUR, D_Te, CGP_MINUTE, D_Te, CGP_SECOND, RP_BLANKq, CGP_TZZ, "\""),
        ...
        CGN_YEAR, CGN_TZ,
        &[
            (53, 73, (O_Z, 2000, 1, 2, 5, 1, 32, 0), br#"{"level":"INFO", b"message":"Started", b"timestamp":"2000-01-02T05:01:32Z"}"#),
            (16, 39, (O_M8, 2000, 1, 2, 5, 1, 32, 0), br#"{"TIMESTAMP" : "2000/01/02 05-01-32 PST", b"data" : ""}"#),
        ],
        line!(),
    ),
    ...
    ERE_REGEX_DATETIME!(
        109,
        counter!(DP_KEY),
        concat!(r#""(TIMESTAMP|Timestamp|timestamp)""#, RP_BLANKq, ":", RP_BLANKq, "\"", CGP_YEAR, D_Dq, CGP_MONTHm, D_Dq, CGP_DAYde, D_DHcdq, CGP_HOUR, D_Te, CGP_MINUTE, D_Te, CGP_SECOND, RP_BLANKq, CGP_TZzc, "\""),
        DfaU8,
        DTFSS_YmdHMSzc,
        0, 2056,
        CGN_YEAR, CGN_TZ,
        &[
            (53, 79, (O_Z, 2000, 1, 2, 5, 1, 32, 0), br#"{"level":"INFO", b"message":"Started", b"timestamp":"2000-01-02T05:01:32 +00:00"}"#),
            (16, 41, (O_M8, 2000, 1, 2, 5, 1, 32, 0), br#"{"TIMESTAMP" : "2000/01/02 05-01-32-08:00", b"data" : ""}"#),
        ],
        line!(),
    ),
    ...
    ERE_REGEX_DATETIME!(
        ...
        CGN_YEAR, CGN_TZ,
        &[
            (53, 77, (O_Z, 2000, 1, 2, 5, 1, 32, 0), br#"{"level":"INFO", b"message":"Started", b"timestamp":"2000-01-02T05:01:32+0000"}"#),
            (16, 41, (O_M8, 2000, 1, 2, 5, 1, 32, 0), br#"{"TIMESTAMP" : "2000/01/02 05-01-32 -0800", b"data" : ""}"#),
        ],
        line!(),
    ),
    ...
    ERE_REGEX_DATETIME!(
        111,
        counter!(DP_KEY),
        concat!(r#""(TIMESTAMP|Timestamp|timestamp)""#, RP_BLANKq, ":", RP_BLANKq, "\"", CGP_YEAR, D_Dq, CGP_MONTHm, D_Dq, CGP_DAYde, D_DHcdq, CGP_HOUR, D_Te, CGP_MINUTE, D_Te, CGP_SECOND, RP_BLANKq, CGP_TZzp, "\""),
        DfaU8,
        DTFSS_YmdHMSzp,
        0, 2056,
        CGN_YEAR, CGN_TZ,
        &[
            (53, 76, (O_Z, 2000, 1, 2, 5, 1, 32, 0), br#"{"level":"INFO", b"message":"Started", b"timestamp":"2000-01-02T05:01:32 +00"}"#),
            (16, 39, (O_M8, 2000, 1, 2, 5, 1, 32, 0), br#"{"TIMESTAMP" : "2000/01/02 05-01-32 -08", b"data" : ""}"#),
        ],
        line!(),
    ),
    ...
    ERE_REGEX_DATETIME!(
        112,
        counter!(DP_KEY),
        concat!(r#""(TIMESTAMP|Timestamp|timestamp)""#, RP_BLANKq, ":", RP_BLANKq, "\"", CGP_YEAR, D_Dq, CGP_MONTHm, D_Dq, CGP_DAYde, D_DHcdq, CGP_HOUR, D_Te, CGP_MINUTE, D_Te, CGP_SECOND, "\""),
        DfaU8,
        DTFSS_YmdHMS,
        0, 2056,
        CGN_YEAR, CGN_SECOND,
        &[
            (53, 72, (O_L, 2000, 1, 2, 5, 1, 32, 0), br#"{"level":"INFO", b"message":"Started", b"timestamp":"2000-01-02T05:01:32"}"#),
            (16, 35, (O_L, 2000, 1, 2, 5, 1, 32, 0), br#"{"TIMESTAMP" : "2000/01/02 05:01:32", b"data" : ""}"#),
        ],
        line!(),
    ),
    ...
    ERE_REGEX_DATETIME!(
        113,
        counter!(DP_KEY),
        concat!(r#""(DATETIME|Datetime|datetime)""#, RP_BLANKq, ":", RP_BLANKq, "\"", CGP_YEAR, D_Dq, CGP_MONTHm, D_Dq, CGP_DAYde, D_DHcdq, CGP_HOUR, D_Te, CGP_MINUTE, D_Te, CGP_SECOND, D_SF, CGP_FRACTIONAL19, RP_BLANKq, CGP_TZZ, "\""),
        ...
        CGN_YEAR, CGN_TZ,
        &[
            (52, 76, (O_Z, 2000, 1, 2, 5, 1, 32, 123000000), br#"{"level":"INFO", b"message":"Started", b"datetime":"2000-01-02T05:01:32.123Z"}"#),
            (15, 42, (O_M8, 2000, 1, 2, 5, 1, 32, 123000000), br#"{"DATETIME" : "2000/01/02 05-01-32.123 PST", b"data" : ""}"#),
        ],
        line!(),
    ),
    ...
    ERE_REGEX_DATETIME!(
        114,
        counter!(DP_KEY),
        concat!(r#""(DATETIME|Datetime|datetime)""#, RP_BLANKq, ":", RP_BLANKq, "\"", CGP_YEAR, D_Dq, CGP_MONTHm, D_Dq, CGP_DAYde, D_DHcdq, CGP_HOUR, D_Te, CGP_MINUTE, D_Te, CGP_SECOND, D_SF, CGP_FRACTIONAL19, RP_BLANKq, CGP_TZzc, "\""),
        DfaU8,
        DTFSS_YmdHMSfzc,
        0, 2056,
        CGN_YEAR, CGN_TZ,
        &[
            (52, 81, (O_Z, 2000, 1, 2, 5, 1, 32, 123000000), br#"{"level":"INFO", b"message":"Started", b"datetime":"2000-01-02T05:01:32.123+00:00"}"#),
            (15, 45, (O_M8, 2000, 1, 2, 5, 1, 32, 123000000), br#"{"DATETIME" : "2000/01/02 05-01-32.123 -08:00", b"data" : ""}"#),
        ],
        line!(),
    ),
    ...
    ERE_REGEX_DATETIME!(
        ...
        CGN_YEAR, CGN_TZ,
        &[
            (52, 80, (O_Z, 2000, 1, 2, 5, 1, 32, 123000000), br#"{"level":"INFO", b"message":"Started", b"datetime":"2000-01-02T05:01:32.123+0000"}"#),
            (15, 44, (O_M8, 2000, 1, 2, 5, 1, 32, 123000000), br#"{"DATETIME" : "2000/01/02 05-01-32.123 -0800", b"data" : ""}"#),
        ],
        line!(),
    ),
    ...
    ERE_REGEX_DATETIME!(
        116,
        counter!(DP_KEY),
        concat!(r#""(DATETIME|Datetime|datetime)""#, RP_BLANKq, ":", RP_BLANKq, "\"", CGP_YEAR, D_Dq, CGP_MONTHm, D_Dq, CGP_DAYde, D_DHcdq, CGP_HOUR, D_Te, CGP_MINUTE, D_Te, CGP_SECOND, D_SF, CGP_FRACTIONAL19, RP_BLANKq, CGP_TZzp, "\""),
        DfaU8,
        DTFSS_YmdHMSfzp,
        0, 2056,
        CGN_YEAR, CGN_TZ,
        &[
            (52, 79, (O_Z, 2000, 1, 2, 5, 1, 32, 123000000), br#"{"level":"INFO", b"message":"Started", b"datetime":"2000-01-02T05:01:32.123 +00"}"#),
            (15, 41, (O_M8, 2000, 1, 2, 5, 1, 32, 123000000), br#"{"DATETIME" : "2000/01/02 05-01-32.123-08", b"data" : ""}"#),
        ],
        line!(),
    ),
    ...
    ERE_REGEX_DATETIME!(
        117,
        counter!(DP_KEY),
        concat!(r#""(DATETIME|Datetime|datetime)""#, RP_BLANKq, ":", RP_BLANKq, "\"", CGP_YEAR, D_Dq, CGP_MONTHm, D_Dq, CGP_DAYde, D_DHcdq, CGP_HOUR, D_Te, CGP_MINUTE, D_Te, CGP_SECOND, D_SF, CGP_FRACTIONAL19, "\""),
        DfaU8,
        DTFSS_YmdHMSf,
        0, 2056,
        CGN_YEAR, CGN_FRACTIONAL,
        &[
            (52, 75, (O_L, 2000, 1, 2, 5, 1, 32, 123000000), br#"{"level":"INFO", b"message":"Started", b"datetime":"2000-01-02T05:01:32.123"}"#),
            (15, 38, (O_L, 2000, 1, 2, 5, 1, 32, 123000000), br#"{"DATETIME" : "2000/01/02 05-01-32.123", b"data" : ""}"#),
        ],
        line!(),
    ),
    ...
    ERE_REGEX_DATETIME!(
        118,
        counter!(DP_KEY),
        concat!(r#""(DATETIME|Datetime|datetime)""#, RP_BLANKq, ":", RP_BLANKq, "\"", CGP_YEAR, D_Dq, CGP_MONTHm, D_Dq, CGP_DAYde, D_DHcdq, CGP_HOUR, D_Te, CGP_MINUTE, D_Te, CGP_SECOND, RP_BLANKq, CGP_TZZ, "\""),
        ...
        CGN_YEAR, CGN_TZ,
        &[
            (52, 72, (O_Z, 2000, 1, 2, 5, 1, 32, 0), br#"{"level":"INFO", b"message":"Started", b"datetime":"2000-01-02T05:01:32Z"}"#),
            (15, 38, (O_M8, 2000, 1, 2, 5, 1, 32, 0), br#"{"DATETIME" : "2000/01/02 05-01-32 PST", b"data" : ""}"#),
        ],
        line!(),
    ),
    ...
    ERE_REGEX_DATETIME!(
        119,
        counter!(DP_KEY),
        concat!(r#""(DATETIME|Datetime|datetime)""#, RP_BLANKq, ":", RP_BLANKq, "\"", CGP_YEAR, D_Dq, CGP_MONTHm, D_Dq, CGP_DAYde, D_DHcdq, CGP_HOUR, D_Te, CGP_MINUTE, D_Te, CGP_SECOND, RP_BLANKq, CGP_TZzc, "\""),
        DfaU8,
        DTFSS_YmdHMSzc,
        0, 2056,
        CGN_YEAR, CGN_TZ,
        &[
            (52, 78, (O_Z, 2000, 1, 2, 5, 1, 32, 0), br#"{"level":"INFO", b"message":"Started", b"datetime":"2000-01-02T05:01:32 +00:00"}"#),
            (15, 40, (O_M8, 2000, 1, 2, 5, 1, 32, 0), br#"{"DATETIME" : "2000/01/02 05-01-32-08:00", b"data" : ""}"#),
        ],
        line!(),
    ),
    ...
    ERE_REGEX_DATETIME!(
        ...
        CGN_YEAR, CGN_TZ,
        &[
            (52, 76, (O_Z, 2000, 1, 2, 5, 1, 32, 0), br#"{"level":"INFO", b"message":"Started", b"datetime":"2000-01-02T05:01:32+0000"}"#),
            (15, 40, (O_M8, 2000, 1, 2, 5, 1, 32, 0), br#"{"DATETIME" : "2000/01/02 05-01-32 -0800", b"data" : ""}"#),
        ],
        line!(),
    ),
    ...
    ERE_REGEX_DATETIME!(
        121,
        counter!(DP_KEY),
        concat!(r#""(DATETIME|Datetime|datetime)""#, RP_BLANKq, ":", RP_BLANKq, "\"", CGP_YEAR, D_Dq, CGP_MONTHm, D_Dq, CGP_DAYde, D_DHcdq, CGP_HOUR, D_Te, CGP_MINUTE, D_Te, CGP_SECOND, RP_BLANKq, CGP_TZzp, "\""),
        DfaU8,
        DTFSS_YmdHMSzp,
        0, 2056,
        CGN_YEAR, CGN_TZ,
        &[
            (52, 75, (O_Z, 2000, 1, 2, 5, 1, 32, 0), br#"{"level":"INFO", b"message":"Started", b"datetime":"2000-01-02T05:01:32 +00"}"#),
            (15, 38, (O_M8, 2000, 1, 2, 5, 1, 32, 0), br#"{"DATETIME" : "2000/01/02 05-01-32 -08", b"data" : ""}"#),
        ],
        line!(),
    ),
    ...
    ERE_REGEX_DATETIME!(
        122,
        counter!(DP_KEY),
        concat!(r#""(DATETIME|Datetime|datetime)""#, RP_BLANKq, ":", RP_BLANKq, "\"", CGP_YEAR, D_Dq, CGP_MONTHm, D_Dq, CGP_DAYde, D_DHcdq, CGP_HOUR, D_Te, CGP_MINUTE, D_Te, CGP_SECOND, "\""),
        DfaU8,
        DTFSS_YmdHMS,
        0, 2056,
        CGN_YEAR, CGN_SECOND,
        &[
            (52, 71, (O_L, 2000, 1, 2, 5, 1, 32, 0), br#"{"level":"INFO", b"message":"Started", b"datetime":"2000-01-02T05:01:32"}"#),
            (15, 34, (O_L, 2000, 1, 2, 5, 1, 32, 0), br#"{"DATETIME" : "2000/01/02 05:01:32", b"data" : ""}"#),
        ],
        line!(),
    ),
    ...
    ERE_REGEX_DATETIME!(
        ...
        &[
            ...
            (15, 28, (O_L, 2026, 5, 23, 3, 3, 34, 74000000), br#"{"TIMESTAMP" : 1779505414074, b"data" : "DATA!!!"}"#),
            (15, 28, (O_L, 2026, 5, 23, 3, 3, 34, 74000000), br#"{"TIMESTAMP" : 1779505414074 , b"data" : "DATA!!!"}"#),
        ],
        line!(),
    ),
    ...
    ERE_REGEX_DATETIME!(
        ...
        &[
            ...
            (15, 25, (O_L, 2026, 5, 23, 3, 3, 34, 0), br#"{"TIMESTAMP" : 1779505414, b"data" : "DATA!!!"}"#),
            (15, 25, (O_L, 2026, 5, 23, 3, 3, 34, 0), br#"{"TIMESTAMP" : 1779505414 , b"data" : "DATA!!!"}"#),
        ],
        line!(),
    ),
    ...
    ERE_REGEX_DATETIME!(
        125,
        counter!(DP_KEY),
        concat!(r#""(LOGTIME|LogTime|logTime|logtime)""#, RP_BLANKq, ":", RP_BLANKq, "\"", CGP_MONTHm, D_Deq, CGP_DAYde, D_DHcdqus, CGP_HOUR, D_Te, CGP_MINUTE, D_Te, CGP_SECOND, "\""),
        DfaU8,
        DTFSS_mdHMS,
        0, 512,
        CGN_MONTH, CGN_SECOND,
        &[
            (13, 24, (O_L, YD, 2, 26, 5, 27, 26, 0), br#"{"logTime": "0226/052726", b"correlationVector":"A", b"action":"FETCH_UX_CONFIG", b"result":""}"#),
            (13, 24, (O_L, YD, 2, 26, 5, 27, 26, 0), br#"{"LOGTIME" :"0226/052726", b"correlationVector":"A", b"action":"FETCH_UX_CONFIG", b"result":""}"#),
        ],
        line!(),
    ),
