...
/// Compression helpers.
pub mod compress {
    pub use crate::subprojects::lzma_rs::encode::options::*;
}
...
pub mod decompress {
    ...
    pub mod raw {
        ...
        pub use crate::subprojects::lzma_rs::decode::lzma::{LzmaDecoder, LzmaParams, LzmaProperties};
...
pub fn lzma2_decompress<R: io::BufRead, W: io::Write>(
    ...
    decode::lzma2::Lzma2Decoder::new(8 * 1024 * 1024).decompress(input, output)
}
