...
#[cfg(test)]
use crate::subprojects::lzma_rs::util::const_assert;
...
mod test {
    use super::*;
    use crate::subprojects::lzma_rs::decode::rangecoder::{LenDecoder, RangeDecoder};
    use crate::subprojects::lzma_rs::{decode, encode};
    use ::seq_macro::seq;
