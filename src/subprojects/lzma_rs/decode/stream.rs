use crate::subprojects::lzma_rs::decode::lzbuffer::{LzBuffer, LzCircularBuffer};
use crate::subprojects::lzma_rs::decode::lzma::{DecoderState, LzmaParams};
use crate::subprojects::lzma_rs::decode::rangecoder::RangeDecoder;
use crate::subprojects::lzma_rs::decompress::Options;
use crate::subprojects::lzma_rs::error::Error;
use std::fmt::Debug;
    ...
    W: Write,
{
    ...
    pub fn finish(mut self) -> crate::subprojects::lzma_rs::error::Result<W> {
    ...
    fn read_header<R: BufRead>(
        ...
        mut input: &mut R,
        options: &Options,
    ) -> crate::subprojects::lzma_rs::error::Result<State<W>> {
...
mod test {
    ...
    fn test_stream_chunked() {
        ...
        crate::subprojects::lzma_rs::lzma_compress(&mut reader, &mut small_input_compressed).unwrap();
    ...
    fn test_allow_incomplete() {
        ...
        crate::subprojects::lzma_rs::lzma_compress(&mut reader, &mut compressed).unwrap();
