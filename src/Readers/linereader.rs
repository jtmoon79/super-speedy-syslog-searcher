...
impl LineReader {
                ...
                Some(rlp) => {
                    ...
                    match rlp {
                        ResultS4_LineFind::Found(val) => {
                            dpxf!(
                                "return ResultS4_LineFind::Found(({}, …)) @[{}, {}] {:?}",
                                val.0,
                        ...
                        ResultS4_LineFind::Found_EOF(val) => {
                            dpxf!("return ResultS4_LineFind::Found_EOF(({}, …)) @[{}, {}] {:?}", val.0, val.1.fileoffset_begin(), val.1.fileoffset_end(), val.1.to_String_noraw());
                            return Some(ResultS4_LineFind::Found_EOF((val.0, val.1.clone())));
                        }
                        ResultS4_LineFind::Done => {
                            dpxf!("return ResultS4_LineFind::Done");
    ...
    fn check_store(&mut self, fileoffset: FileOffset) -> Option<ResultS4_LineFind> {
        ...
        if self.lines.contains_key(&fileoffset) {
            ...
            if self.is_Line_last(&linep) {
                ...
                dpx!("return ResultS4_LineFind::Found_EOF({}, {:p}) @[{}, {}] {:?}", fo_next, &*linep, (*linep).fileoffset_begin(), (*linep).fileoffset_end(), (*linep).to_String_noraw());
            ...
            dpx!("return ResultS4_LineFind::Found({}, {:p})  @[{}, {}] {:?}", fo_next, &*linep, (*linep).fileoffset_begin(), (*linep).fileoffset_end(), (*linep).to_String_noraw());
        ...
        match self.get_linep(&fileoffset) {
            Some(linep) => {
                ...
                if self.is_Line_last(&linep) {
                    ...
                    dpxf!("return ResultS4_LineFind::Found_EOF({}, {:p}) @[{}, {}] {:?}", fo_next, &*linep, (*linep).fileoffset_begin(), (*linep).fileoffset_end(), (*linep).to_String_noraw());
                    return Some(ResultS4_LineFind::Found_EOF((fo_next, linep)));    
                }
                if self.find_line_lru_cache_enabled {
                    self.find_line_lru_cache_put += 1;
                ...
                dpxf!("return ResultS4_LineFind::Found({}, {:p}) @[{}, {}] {:?}", fo_next, &*linep, (*linep).fileoffset_begin(), (*linep).fileoffset_end(), (*linep).to_String_noraw());
                return Some(ResultS4_LineFind::Found((fo_next, linep)));
            }
            None => {
    ...
    pub fn find_line_in_block(&mut self, fileoffset: FileOffset) -> ResultS4_LineFind {
        ...
        if filesz == 0 {
            dpxf!("({}): return ResultS4_LineFind::Done; file is empty", fileoffset);
            ...
            dpxf!("({}): return ResultS4_LineFind::Done; fileoffset {} was too big filesz {}!", fileoffset, fileoffset, filesz);
            return ResultS4_LineFind::Done;
        } else if fileoffset == filesz {
            dpxf!("({}): return ResultS4_LineFind::Done(); fileoffset {} is at end of file {}!", fileoffset, fileoffset, filesz);
            return ResultS4_LineFind::Done;
        }
        ...
        if found_nl_a {
            ...
            if !nl_b_eof {
                ...
                dpxf!("({}) A0: return ResultS4_LineFind::Found(({}, @{:p})) @[{}, {}] {:?}", fileoffset, fo_next, linep, (*linep).fileoffset_begin(), (*linep).fileoffset_end(), (*linep).to_String_noraw());
                ...
                dpxf!("({}) A0: return ResultS4_LineFind::Found_EOF(({}, @{:p})) @[{}, {}] {:?}", fileoffset, fo_next, linep, (*linep).fileoffset_begin(), (*linep).fileoffset_end(), (*linep).to_String_noraw());
        ...
        if fileoffset >= charsz_fo {
            ...
            if self.lines.contains_key(&fo_) {
                ...
                dpxf!("({}): return ResultS4_LineFind::Found({}, {:p})  @[{}, {}] {:?}", fileoffset, fo_next, &*linep, (*linep).fileoffset_begin(), (*linep).fileoffset_end(), (*linep).to_String_noraw());
    ...
    pub fn find_line(&mut self, fileoffset: FileOffset) -> ResultS4_LineFind {
        ...
        if line.count_lineparts() == 0 {
            ...
            dpxf!("({}) C: return ResultS4_LineFind::Done;", fileoffset);
            return ResultS4_LineFind::Done;
        }
        ...
        dpxf!(
            "({}) D: return ResultS4_LineFind::Found(({}, @{:p})) @[{}, {}] {:?}",
            fileoffset,
            fo_end + 1,
            &*linep,
