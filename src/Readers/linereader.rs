...
impl LineReader {
    ...
    fn block_find_byte_forwards(&mut self, bof: BlockOffset, begin: Option<BlockIndex>, byte_: u8) -> ResultS3_find_byte
    {
        ...
        assert_ge!(bi_end, self.charsz_ as BlockIndex, "blockindex bi_end {} is less than charsz; not yet handled", bi_end);
        debug_eprintln!(
        ...
        loop {
            ...
            if (*bptr)[bi_beg] == byte_ {
                ...
                bi_beg += self.charsz_ as BlockIndex;
            }
            if bi_beg >= bi_end {
                break;
            }
    ...
    fn block_find_byte_backwards(&mut self, bof: BlockOffset, begin: Option<BlockIndex>, byte_: u8) -> ResultS3_find_byte
    {
        ...
        assert_ge!(bi_end, self.charsz_, "blockindex bi_end {} is less than charsz; not yet handled", bi_end);
        debug_eprintln!(
        ...
        loop {
            ...
            bi_end -= self.charsz_ as BlockIndex;
            if bi_end < bi_beg {
                break;
            }
        }  // end loop
